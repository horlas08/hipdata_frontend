...
import { LanguageOption, ProfileFormModel, ProfileProps } from '@/@types/user'
...
const validationSchema = Yup.object().shape({
    ...
    avatar: Yup.mixed()
        .optional()
        .test('Must Be image', 'File ', (value: File) => value),
    lang: Yup.string(),
    country: Yup.string(),
    syncData: Yup.bool(),
})
    ...
    return (
        ...
        >
            {({ values, touched, errors, isSubmitting, resetForm }) => {
                ...
                const userImagePath = `${appConfig.apiWeb}/assets/images/user/${user.avatar}`
