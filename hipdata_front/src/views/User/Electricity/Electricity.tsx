...
const Electricity = () => {
    ...
    const handlePinOk = async (_values: DiscoFormType) => {
                    ...
                    <Form>
                        <FormContainer>
                                    ...
                                    <Field name="meter_type">
                                        {({
                                            ...
                                            <Select
                                                ...
                                                isLoading={meter_typeIsLoading}
                                                value={meterTypes.filter(
                                                    (option: DiscoType) =>
                                                        option.value ===
                                                        values.meter_type
                                                )}
                            ...
                            <div>
                                <FormItem
                                    className="w-full"
                                    label="Meter number / meter_number number"
                                    invalid={
                                        errors.meter_number &&
